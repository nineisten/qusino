...
| **In-dApp Liquidity Pool**   | **10%** | Auto-injected into QUSINO/ETH (or native pair) liquidity on Uniswap V3 or equivalent. Ensures **deep liquidity**, **low slippage**, and **price stability**. *The market backbone.* |
| **Shareholders (QUSINO Stakers)** | **50%** | **Directly distributed** to token holders via staking rewards, dividends, or buyback-and-burn. *The ultimate alignment.* |
...
pie title Qusino Revenue Flywheel
    ...
    "Liquidity Pool (10%)" : 10
    "Shareholders – Stakers & Holders (50%)" : 50